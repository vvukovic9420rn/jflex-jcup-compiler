...
/** CUP v0.10k generated parser.
  * @version Thu Jan 13 22:37:08 CET 2022
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$MPParser$act_num)
		...
		Type f = (Type)((java_cup.runtime.Symbol) CUP$MPParser$stack.elementAt(CUP$MPParser$top-0)).value;
            ...
            RESULT = f;
            System.out.println("term -> factor " + f);
		...
		Type f = (Type)((java_cup.runtime.Symbol) CUP$MPParser$stack.elementAt(CUP$MPParser$top-0)).value;
            ...
            if(m != null && m.equals("mod")){
                ...
                System.out.println("term " + t + " " + "operator " + m + " " + f);
            }
